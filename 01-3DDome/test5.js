...
function iColumnH(aArr){
    ...
    for(var i=0;i<columnNum;i++){
        aArr[i].style.display='block';
        aArr[i].style.transform='translate3D('+aArr[i].columnX+'px,'+aArr[i].columnY+'px,'+aArr[i].columnZ+'px) rotateY('+
        aArr[i].columnPhi+'rad)';
    }
}

// 曲面柱体
function iColumnH2(aArr){
    for(var i=0;i<aArr.length;i++){
        aArr[i].style.display='none';
    }
    ...
    for(var i=0;i<columnNum;i++){
        aArr[i].style.display='block';
        aArr[i].style.transform='translate3D('+aArr[i].columnX2+'px,'+aArr[i].columnY2+'px,'+aArr[i].columnZ2+'px) rotateY('+
                                aArr[i].columnPhi2+'rad)';
    }
}